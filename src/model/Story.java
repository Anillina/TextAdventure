...
public class Story {
    ...
    private void setSentencesAndChoices() {
        ...
        sentences[18][2][0]="<html><body> I decided to hide in the closet after a while the beast shows up . It seems like it wants to check the closet and grabs in between the polls of the closet. Scared to death I chose to jump out of it and try to find something <br> to defense myself. Realizing that an axe was laying in the corner I sprinted and grabbed it. After I chopped her into pieces her blood came splashing out.Suddenly My vision began to distort<br> , my view slowly faded to black and then as it all became clear , I saw a women with blond hair . At the location where the monstrosity layed. In total shock I tried to bring my senses back together but utterly failed. However a little hand pushed me from behind and suddenly I fall again into the dark abyss...</body></html>";
        ...
        sentences[19][3][0]="<html><body>I do not quite understand what is happening and why it is . But it feels like a terrible endless nightmare that just continues until I will lose my mind.\n" +
        ...
        sentences[19][4][0]="<html><body>Go ahead<br>Look at picture</body></html>";
        ...
        sentences[19][4][1]="Auswahltext 1";
        ...
        sentences[20][3][0]="<html><body>As I go further through the corridor and bypass every picture , a strong urge to look at them overcomes me. Even though I try my hardest to avoid them , it does not matter .                                   \n" +
        ...
        sentences[20][4][0]="<html><body>Think<br>Continue</body></html>";
        ...
        sentences[20][4][1]="Auswahltext 1";
        ...
        sentences[21][3][0]="<html><body>What did she mean . I don't understand it  like I have never seen her before beside that one time in the forest . She should not even be here , I am definitely having a nightmare \n" +
        ...
        sentences[21][4][0]="<html><body>Return<br>Rest</body></html>";
        ...
        sentences[21][4][1]="Auswahltext 1";
        ...
        sentences[22][1][0]="<html><body>I decide to return to the beginning of the corridor , so I turn around and walk back. The only thing I want now is going home and just walking through this corridor won't bring me back.\n" +
                ...
                "I did not know that dying could be that redeeming.</body></html>";
        ...
        sentences[23][1][0]="<html><body>I should just take a short break and forget about anything . Forget about the current and hopeless situation , forget about the things that I have done and forget about the girl.\n" +
                ...
                "the floor and starts to stab me , again and again until I lose consciousness and finally end up dying .</body></html>";
        ...
        sentences[24][3][0]="<html><body>I decide to make my way forward. Even though I try my best, it is unnecessary , I am not achieving any progress . It looks like I don't even move by an inch. The pictures are the same and the corridor too\n" +
        ...
        sentences[24][4][0]="<html><body>Rest<br>Dont rest</body></html>";
        ...
        sentences[24][4][1]="Auswahltext 1";
        sentences[24][5][1]="Auswahl 1";
        sentences[24][6][1]="Auswahl 2";

        //layer 3-4aba
        sentences[25]=new String [3][2];

        sentences[25][0][0]="3,4aba";
        sentences[25][1][0]="3,4aab";
        sentences[25][2][0]="<html><body>I decide not to rest . I try to keep moving but my body feels so tired. Suddenly I lost all tension in my bones and fall and lose consciousness.</body></html>";
        ...
        sentences[26][3][0]="<html><body>As I take a second peek at the picture my head starts to hurt , it implies that I start to remember some important detail . But after I hear footsteps and turn around to look where these are coming from\n" +
        ...
        sentences[26][4][0]="<html><body>Dont forget<br>Forget</body></html>";
        ...
        sentences[26][4][1]="Auswahltext 1";
        ...
        sentences[27][3][0]="<html><body>It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .It hurts .\n" +
        ...
        sentences[27][4][0]="<html><body>...<br>Stop</body></html>";
        sentences[27][5][0]="...";
        ...
        sentences[27][4][1]="Auswahltext 1";
        ...
        sentences[28][1][0]="<html><body>Why did I kill my mother?\n" +
                ...
                "I won't escape this hell.</body></html>";

        sentences[28][1][1]="Text 1";

        //layer 3-3bb
        sentences[27]=new String [5][2];

        sentences[29][0][0]="3,3bb";
        sentences[29][1][0]="3,4baa";
        sentences[29][2][0]="<html><body>Why should It even matter if I think about it more . Everything here is just absurd I never had such a weird and confusing nightmare . The only thing that I should do now is \n" +
                "to rest. I feel exhausted , I need a break from all of this madness.</body></html>";
        sentences[29][3][0]="<html><body>Rest</body></html>";
        sentences[29][4][0]="Rest";


        sentences[29][1][1]="Ort 1";
        sentences[29][2][1]="Text 1";
        sentences[29][3][1]="Auswahltext 1";
