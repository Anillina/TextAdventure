...
public class Story {
    ...
    private void setSentencesAndChoices() {
        ...
        sentences[0][2][1]="Go to the left";//3
        sentences[0][2][2]="Go to the right";//4
        sentences[0][2][3]="Move forward";//5
        sentences[0][2][4]="<html><body>Go to the left<br>Go to the right<br>Move forward</body></html>";
        ...
        sentences[0][3][1]="Eat the rat";//6
        sentences[0][3][2]="Eat some centipedes";//7
        sentences[0][3][3]="Eat an eyeball";//8
        sentences[0][3][4]="Go on";//5
        sentences[0][3][5]="<html><body>Eat the rat<br>Eat some centipedes<br>Eat an eyeball<br>Go on</body></html>";
        ...
        sentences[0][4][2]="run away";//13
        sentences[0][4][3]="<html><body>Stay<br>Run away</body></html>";
        ...
        sentences[0][5][1]="Keep it";//09
        sentences[0][5][2]="Eat it";//Level 10
        sentences[0][5][3]="Ignore it";//3
        sentences[0][5][4]="<html><body>Keep it<br>Eat it<br>Ignore it</body></html>";
        ...
        sentences[0][6][1]="go deeper into the forest";//11
        sentences[0][6][2]="return";//11
        sentences[0][6][3]="<html><body>go deeper into the forest<br>return</body></html>";
        ...
        sentences[0][7][1]="go deeper into the forest";//11
        sentences[0][7][2]="return";//11
        sentences[0][7][3]="<html><body>go deeper into the forest<br>return</body></html>";
        ...
        sentences[0][8][1]="go deeper into the forest";//11
        sentences[0][8][2]="return";//11
        sentences[0][8][3]="<html><body>go deeper into the forest<br>return</body></html>";
        ...
        sentences[0][11][2]="run away";//13
        sentences[0][8][3]="<html><body>stay<br>run away</body></html>";
